...
namespace PersonDataManagement
{
    ...
    {  
        ...
        public static void AddingPersonDetails(List<Person> list)
        {
            ...
            list.Add(new Person() { SSN = 3, Name = "Yash", Address = "Pune", Age = 21 });
            list.Add(new Person() { SSN = 4, Name = "Dhruv", Address = "Nagpur", Age = 22 });
            list.Add(new Person() { SSN = 5, Name = "siya", Address = "Banglore", Age = 30 });
            list.Add(new Person() { SSN = 6, Name = "nitya", Address = "Bhopal", Age = 12 });
